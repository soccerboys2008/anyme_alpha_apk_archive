...
# static fields
.field private static final k:Lts1;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lts1;->k:Lts1;

    sget-object v0, Lts1;->k:Lts1;
...
.method static synthetic l()Lts1;
    .locals 1
...
.method protected final a(Ljt1$j;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_0
    sget-object p2, Lts1;->l:Lrt1;

    if-nez p2, :cond_0

    new-instance p2, Ljt1$c;

    sget-object p3, Lts1;->k:Lts1;

    invoke-direct {p2, p3}, Ljt1$c;-><init>(Ljt1;)V

    sput-object p2, Lts1;->l:Lrt1;
    ...
    invoke-virtual {p2}, Lft1;->b()Z

    move-result p3

    iput-boolean p3, p0, Lts1;->i:Z
    ...
    invoke-virtual {p0}, Lts1;->j()Z

    move-result p2

    iget v0, p0, Lts1;->h:I

    invoke-virtual {p3}, Lts1;->j()Z
    ...
    invoke-virtual {p0}, Lts1;->i()Z

    move-result p2

    iget-boolean v0, p0, Lts1;->i:Z

    invoke-virtual {p3}, Lts1;->i()Z

    move-result v1

    iget-boolean v2, p3, Lts1;->i:Z

    invoke-interface {p1, p2, v0, v1, v2}, Ljt1$k;->a(ZZZZ)Z

    move-result p2

    iput-boolean p2, p0, Lts1;->i:Z

    invoke-virtual {p0}, Lts1;->k()Z

    move-result v1

    iget-wide v2, p0, Lts1;->j:J

    invoke-virtual {p3}, Lts1;->k()Z

    move-result v4

    iget-wide v5, p3, Lts1;->j:J
    ...
    invoke-direct {p1, v0}, Lts1$a;-><init>(Los1;)V
