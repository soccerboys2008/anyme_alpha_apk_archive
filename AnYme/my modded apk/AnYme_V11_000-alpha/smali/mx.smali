...
.method public static b(Ly70;)Z
    ...
    invoke-virtual {p0, v0, v3, v1}, Ly70;->a([BII)V

    sget-object p0, Lmx;->o:[B
...
.method protected a(Ly70;)J
    ...
    invoke-direct {p0, p1}, Lmx;->a([B)J

    move-result-wide v0

    invoke-virtual {p0, v0, v1}, Lnx;->b(J)J
...
.method protected a(Ly70;JLnx$b;)Z
    ...
    iget-boolean p2, p0, Lmx;->n:Z

    const/4 p3, 0x1

    if-nez p2, :cond_0

    iget-object p2, p1, Ly70;->a:[B
    ...
    invoke-direct {p0, v7, p2}, Lmx;->a(Ljava/util/List;I)V

    const/16 p1, 0xf00

    invoke-direct {p0, v7, p1}, Lmx;->a(Ljava/util/List;I)V
