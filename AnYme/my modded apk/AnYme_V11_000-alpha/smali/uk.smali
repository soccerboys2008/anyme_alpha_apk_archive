...
.method private static a(Ljava/nio/ByteBuffer;)Luk$b;
    .locals 3
    ...
    invoke-direct {v0, v1, v2, p0}, Luk$b;-><init>([BII)V
...
.method public static b(Ljava/nio/ByteBuffer;)[B
    ...
    invoke-static {p0}, Luk;->a(Ljava/nio/ByteBuffer;)Luk$b;

    move-result-object v0

    if-eqz v0, :cond_0

    iget v1, v0, Luk$b;->a:I

    if-nez v1, :cond_0

    iget v1, v0, Luk$b;->b:I

    iget-object v0, v0, Luk$b;->c:[B
...
.method public static c(Ljava/nio/ByteBuffer;)Ljava/io/InputStream;
    ...
    invoke-direct {v0, p0}, Luk$a;-><init>(Ljava/nio/ByteBuffer;)V
