...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v1, Landroidx/transition/q;->e:[I
    ...
    invoke-static {p1, p2, v1, v0, v0}, Ls1;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IZ)Z
    ...
    invoke-static {p1, p2, v1, v2, v0}, Ls1;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IZ)Z
...
.method private a(Landroidx/transition/v;Landroidx/transition/v;Z)Landroid/animation/ObjectAnimator;
    .locals 12
    ...
    :cond_2
    iget-object v0, p2, Landroidx/transition/v;->a:Ljava/util/Map;
    ...
    iget-object v5, p2, Landroidx/transition/v;->b:Landroid/view/View;
...
.method static a(Landroid/view/View;FFFFFFFF)V
    ...
    invoke-static {p0, p3}, Lz3;->b(Landroid/view/View;F)V
...
.method private a(Landroid/view/ViewGroup;Landroid/view/ViewGroup;)Z
    ...
    :cond_0
    invoke-virtual {p0, p1, v1}, Landroidx/transition/Transition;->a(Landroid/view/View;Z)Landroidx/transition/v;
...
.method private b(Landroid/view/ViewGroup;Landroidx/transition/v;Landroidx/transition/v;)V
    .locals 3

    iget-object v0, p3, Landroidx/transition/v;->b:Landroid/view/View;

    iget-object v1, p3, Landroidx/transition/v;->a:Ljava/util/Map;
    ...
    invoke-static {p1, v2}, Landroidx/transition/h0;->c(Landroid/view/View;Landroid/graphics/Matrix;)V
    ...
    iget-object v2, p2, Landroidx/transition/v;->b:Landroid/view/View;
    ...
    iget-object p2, p3, Landroidx/transition/v;->b:Landroid/view/View;
    ...
    invoke-static {v0, p1}, Landroidx/transition/h0;->a(Landroid/view/View;F)V

    :cond_3
    return-void
.end method

.method private b(Landroidx/transition/v;Landroidx/transition/v;)V
    .locals 4
    ...
    iget-object p2, p2, Landroidx/transition/v;->b:Landroid/view/View;
...
.method public a(Landroid/view/ViewGroup;Landroidx/transition/v;Landroidx/transition/v;)Landroid/animation/Animator;
    ...
    iget-object v0, p3, Landroidx/transition/v;->a:Ljava/util/Map;
    ...
    iget-object v2, p3, Landroidx/transition/v;->a:Ljava/util/Map;
    ...
    invoke-direct {p0, p2, p3}, Landroidx/transition/ChangeTransform;->b(Landroidx/transition/v;Landroidx/transition/v;)V

    :cond_4
    invoke-direct {p0, p2, p3, v1}, Landroidx/transition/ChangeTransform;->a(Landroidx/transition/v;Landroidx/transition/v;Z)Landroid/animation/ObjectAnimator;
    ...
    invoke-direct {p0, p1, p2, p3}, Landroidx/transition/ChangeTransform;->b(Landroid/view/ViewGroup;Landroidx/transition/v;Landroidx/transition/v;)V
...
.method public a(Landroidx/transition/v;)V
    ...
    invoke-direct {p0, p1}, Landroidx/transition/ChangeTransform;->d(Landroidx/transition/v;)V
